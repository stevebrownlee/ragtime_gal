...
LLM_MODEL = os.getenv('LLM_MODEL', 'ilyr')  # Use the custom ilyr model by default
...
def query(question: str,
    ...
    Args:
        ...
        template_name (str, optional): The prompt template to use. Defaults to env var or 'ilyr'
    ...
    try:
        ...
        if template_name is None:
            template_name = os.getenv('PROMPT_TEMPLATE', 'ilyr')
